...
sed -e "s/{{day}}/$day/g" "template.kt" > "src/main/kotlin/$day/$day.kt"
...
curl -k -s --cookie $session "https://adventofcode.com/2022/day/$1/input" -o "src/main/kotlin/$day/input.txt"